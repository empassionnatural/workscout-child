...
<?php 
		...
		if(!empty($external_apply)) {
		    echo get_job_manager_template( 'job-application.php' );
			echo '<p class="text-center mbs"><span class="border-center">'.esc_html__( 'OR', 'workscout' ).'</span><br/><a class="" target="_blank" href="'.esc_url($external_apply).'">'.esc_html__( 'Visit via external link', 'workscout' ).'</a></p>';
