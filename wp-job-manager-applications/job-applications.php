				...
				<?php foreach ( $applications as $application ) : ?>
					<div class="application job-application" id="application-<?php echo esc_attr( $application->ID ); ?>">
						<div class="app-content">
							<!-- Name / Avatar -->
							<div class="info <?php echo $application->ID; ?>">
								...
								<ul>
									...
									<?php
                                        ...
                                        if ( $phone = get_job_application_phone( $application->ID ) ) :
                                        ?>
                                        <li><a href="tel:<?php echo esc_attr( $phone ); ?>" title="<?php esc_html_e( 'Phone number', 'workscout' ); ?>" class="bjob-application-contact"><i class="fa fa-phone-square"></i>  <?php esc_html_e( 'Phone', 'workscout' ); ?></a></li>
									<?php endif; ?>
									<?php if ( $email = get_job_application_email( $application->ID ) ) : ?>
										<li class="test-email"><a href="mailto:<?php echo esc_attr( $email ); ?>?subject=<?php echo esc_attr( sprintf( esc_html__( 'Your job application for %s', 'workscout' ), strip_tags( get_the_title( $job_id ) ) ) ); ?>&amp;body=<?php echo esc_attr( sprintf( esc_html__( 'Hello %s', 'workscout' ), get_the_title( $application->ID ) ) ); ?>" title="<?php esc_html_e( 'Email', 'workscout' ); ?>" class="bjob-application-contact"><i class="fa fa-envelope"></i>  <?php esc_html_e( 'Email', 'workscout' ); ?></a></li>
									<?php endif; ?>
									<?php 
